...
class MCPToolDefinition(BaseModel):
    ...
    code: Optional[str] = Field(None, description="The actual Python code of the tool function generated by the LLM.")
...
class MCPToolResponse(BaseModel):
    ...
    output: Union[str, Dict[str, Any], None] = Field(..., description="The output of the tool execution. Can be a string, a dictionary, or None if an error occurred.")
    call_id: str | None = Field(None, description="The unique identifier for the tool call, matching the request's call_id.")
    # Added field for error messages
    error_message: Optional[str] = Field(None, description="Detailed error message if the tool execution failed.")
